...
case $flavour in
	...
	2)
           ...
           git clone https://github.com/PainKiller3/device_asus_msm8916-common.git device/asus/msm8916-common -b 9
    	   git clone https://github.com/PainKiller3/device_asus_Z010D device/asus/Z010D -b 9
    	   git clone https://github.com/PainKiller3/vendor_Z010D.git vendor/asus -b 9
     	   git clone https://github.com/ShadowReaper1/android_kernel_asus_msm8916-1 kernel/asus/msm8916 -b lineage-16.0
